...
class QuitMainloopScreen(Screen):
	def __init__(self, session, retvalue=1):
		...
		text = { 1: _("Your Vu+ Solo2 is shutting down"),
			2: _("Your Vu+ Solo2 is rebooting"),
			3: _("The user interface of your Vu+ Solo2 is restarting"),
			4: _("Your frontprocessor will be upgraded\nPlease wait until your Vu+ Solo2 reboots\nThis may take a few minutes"),
			5: _("The user interface of your Vu+ Solo2 is restarting\ndue to an error in mytest.py"),
